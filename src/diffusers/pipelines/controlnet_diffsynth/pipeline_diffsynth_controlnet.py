...
class DiffsynthControlNetPipeline(
    DiffusionPipeline, DiffsynthLoraLoaderMixin, FromSingleFileMixin, DiffsynthIPAdapterMixin
):
    r"""
    Args:
        transformer ([`DiffsynthTransformer2DModel`]):
