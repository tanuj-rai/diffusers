...
class DiffsynthControlNetOutput(DiffsynthControlNetOutput):
    def __init__(self, *args, **kwargs):
        ...
        deprecate("diffusers.models.controlnet_diffsynth.DiffsynthControlNetOutput", "0.34", deprecation_message)
...
class DiffsynthControlNetModel(DiffsynthControlNetModel):
    def __init__(
        ...
        deprecation_message = "Importing `DiffsynthControlNetModel` from `diffusers.models.controlnet_diffsynth` is deprecated and this will be removed in a future version. Please use `from diffusers.models.controlnets.controlnet_sd3 import SD3ControlNetModel`, instead."
